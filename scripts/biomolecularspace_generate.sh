...
sources[1]='ncbi_taxonomy https://raw.github.com/dklassen/bio2rdf-scripts/master/taxonomy/ncbi_taxonomy_parser.php'
...
sources[5]="goa https://raw.github.com/dklassen/bio2rdf-scripts/master/goa/goa.php"
...
if [ ! -d "$data_dir/hgnc" ];
	...
	echo "INFO: Skipping HGNC since its already downloaded"
fi
